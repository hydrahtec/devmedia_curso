...
let dia_semana = data_atual.getDay() // 0 a 6

let serie_do_dia = colecao_series_programacao[dia_semana];

let nome_serie = serie_do_dia.nome;

let horario_serie = serie_do_dia.nome;

let sinopse_serie = serie_do_dia.sinopse;

console.log(`Hoje é dia de ${nome_serie} ás ${horario_serie}`);
